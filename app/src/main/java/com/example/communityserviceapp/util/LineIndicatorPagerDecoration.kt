...
/**
 * Util class to add scroll position of horizontal recyclerview using item decorator
 * @See: https://blog.davidmedenjak.com/android/2017/06/24/viewpager-recyclerview.html
 */
class LinePagerIndicatorDecoration : RecyclerView.ItemDecoration() {
    ...
    private val colorActive = getColor(R.color.green)
    private val colorInactive = getColor(R.color.dimgray)
