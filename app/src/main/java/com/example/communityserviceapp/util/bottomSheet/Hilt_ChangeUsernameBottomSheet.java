...
public abstract class Hilt_ChangeUsernameBottomSheet extends BaseBottomSheet implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChangeUsernameBottomSheet_GeneratedInjector) this.generatedComponent()).injectChangeUsernameBottomSheet(UnsafeCasts.unsafeCast(this));
    }
  }
